 ...
 */
package com.super_bits.Super_Bits.jenkins.configAppp;
 ...
 * @author salvioF
 */
public class ConfiguradorCoreJenkinsTestes extends ConfiguradorCoreModelSemPersistencia {

    public ConfiguradorCoreJenkinsTestes() {
