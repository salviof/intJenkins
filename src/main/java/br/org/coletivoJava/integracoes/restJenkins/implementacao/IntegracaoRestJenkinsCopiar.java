...
@InfoIntegracaoRestJenkinsJobs(tipo = FabIntRestJenkinsJobs.COPIAR)
public class IntegracaoRestJenkinsCopiar extends AcaoApiIntegracaoAbstrato {

	public IntegracaoRestJenkinsCopiar(
